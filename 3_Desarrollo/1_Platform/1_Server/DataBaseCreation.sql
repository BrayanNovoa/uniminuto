...
CREATE TABLE tb_estudiantes(
	...
	estudianteCod VARCHAR(20) NOT NULL UNIQUE,
	PRIMARY KEY(estudiante_id)
);

-- INSERT INTO tb_estudiantes (programa_id, periodo_id, estudianteCod) VALUES(1, 6, '000123456');



--CONSULTA QUE SE REALIZA PARA LA INSERCIÓN DE ESTUDIANTES CON SU  RESPECTIVO
-- PROGRAMA, PERIODO, ROL Y ID DEL ESTUSIANTE
INSERT INTO tb_estudiantes (programa_id, periodo_id, estudiante_cod) VALUES((SELECT programa_id FROM tb_programas WHERE programa= 'Tecnología en Desarrollo de Software'),(SELECT periodo_id FROM tb_periodos WHERE periodo ='2016-1'),'000123456');
INSERT INTO tb_estudiantes (programa_id, periodo_id, estudiante) VALUES((SELECT programa_id FROM tb_programas WHERE programa= 'Tecnología en Desarrollo de Software'),(SELECT periodo_id FROM tb_periodos WHERE periodo ='2016-1'),'000123456');
