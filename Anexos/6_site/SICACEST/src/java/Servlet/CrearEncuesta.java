 ...
 * @author b41n
 */
@WebServlet(name = "CrearEncuesta", urlPatterns = {"/createEncuesta"})
public class CrearEncuesta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String descripcionEncuesta = request.getParameter("descripcionEncuesta");
        ConsultasAdmin admin = new ConsultasAdmin();
        if(admin.crearEncuesta(nombreEncuesta, descripcionEncuesta)){
