 ...
 * @author b41n
 */
public class InfoSaludSVL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(con.InfoSalud(usuario, sisben_User, eps_User, problem_User, poblacion_User, difi_User, drink_User, smoke_User)){
