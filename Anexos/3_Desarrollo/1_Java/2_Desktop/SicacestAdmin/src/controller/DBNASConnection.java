...
public class DBNASConnection {
    ...
    public DBNASConnection(String HOST, String USERNAME,String PASSWORD){
        try{
            PORT = "3306";
    ...
    public DBNASConnection(String HOST, String USERNAME,String PASSWORD, String DATABASE){
        try{
            PORT = "3306";
            CLASSNAME = "com.mysql.jdbc.Driver";
            JDBC_MYSQL_DRIVER="jdbc:mysql://";
