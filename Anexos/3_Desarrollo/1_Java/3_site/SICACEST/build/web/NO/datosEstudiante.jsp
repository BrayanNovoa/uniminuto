<%-- 
    ...
    Created on : 9/11/2017, 03:25:59 PM
    Author     : b41n
--%>
...
<html>
    <head>
        ...
        <meta name="description" content="Perfil del estudiante UNIMINUTO.">
        <title>Perfil del estudiante UNIMINUTO.</title>
...
<!--        <script src="js/inhabilitar.js"></script>-->
    ...
    <body>
        <table border="2" width="1000" align="center">
            ...
            <tr bgcolor="#9fa9fb">
                <th colspan="8"><h1 align="center">Datos Básicos del estudiante <%out.print(usuario); %></h1></th>
                <th>
                    <a href="Agregar.jsp">
                        <img src="Iconos/agregar.png" width="30">
                    </a>
                </th>
            </tr>
            <tr bgcolor="9fa9fb">
            ...
            <%
                ...
                try{
                    ...
                    //rs=st.executeQuery("SELECT id_departamento, nombre FROM tb_departamentos ORDER BY nombre ASC;");
            ...
            %>
            <tr bgcolor="#9fa9fb">
                <th colspan="8"><h1 align="center">Información del Pirobo Estudiante <%out.print(usuario); %></h1></th>
                <th>
                    <a href="Agregar.jsp">
                        <img src="Iconos/agregar.png" width="30">
                    </a>
