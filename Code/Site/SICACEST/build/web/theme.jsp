<%-- 
    Document   : theme
    Created on : 25/10/2018, 01:32:03 PM
    Author     : b41n
--%>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#projects">Proceso</a>
            </li>
            <li class="nav-item">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="ingreso" method="post" id="formlogin">
                  <input type="email" class="form-control flex-fill mr-0 mr-sm-2 mb-3 mb-sm-0" id="inputEmail" placeholder="Correo Institucional...">
                </form>
              </div>
        ...
        <div class="row align-items-center no-gutters mb-4 mb-lg-5">
          ...
          <div class="col-xl-4 col-lg-5">
            <div class="featured-text text-center text-lg-left">
              <h4>Estudiantes</h4>
              <p class="text-black-50 mb-0">Asegúrese de tener sus credenciales de acceso antes de ingresar!</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-lg-8 mx-auto text-center">
            ...
            <h2 class="text-white mb-5">Envianos tus inquietudes!</h2>
    ...
    <section id="contact" class="contact-section bg-black">
      <div class="container">
        ...
        <div class="social d-flex justify-content-center">
            <a href="https://www.facebook.com" target="blank" class="mx-2">
            <i class="fab fa-stack-overflow"></i>
          </a>
          <a href="https://" target="blank" class="mx-2">
