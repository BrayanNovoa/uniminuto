<%-- 
    Document   : pestanas
    Created on : 4/04/2017, 09:52:28 AM
    Author     : b41n
--%>
...
<% 
    ...
    //String mail = (String)objSesion.getAttribute("");
            ...
            <div id="content">
                ...
                <!--Contenido del formulario Datos Básicos-->
                    <form action="datosBasicos" class="login" method="">
                        ...
                        <input type="text" name="ape1_User" class="login-input" placeholder="Primer apellido">
                        <input type="text" name="ape2_User" class="login-input" placeholder="Segundo apellido">
                        ...
                        <input type="text" name="ciu_User" class="login-input" placeholder="Ciudad de nacimiento">
                ...
                <!--Contenido del formulario de Vivienda-->
                ...
                <div id="content-salud">
                    <!--Contenido del formulario de Salud-->
                ...
                <div id="content-financiera">
                    <!--Contenido del formulario de Financiera-->
                ...
                <div id="content-familiar">
                    <!--Contenido del formulario de información Familiar-->
